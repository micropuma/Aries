...
@task_tile()
def gemm(A: int32[I, K], B: int32[K, J], C: int32[I, J]):
    ...
    A_L1: int32[TI, TK] = A[ti, tk]  # Load to L1 in core
    B_L1: int32[TK, TJ] = B[tk, tj]  # Load to L1 in core
    C_L1: int32[TI, TJ] = C[ti, tj]  # Load to L1 in core
