...
@task_tile()
def gemm(A: int8[I, K], B: int8[K, J], C: int8[I, J]):
    ...
    A_L1: int8[TI, TK] = A[ti, tk]  # Load to L1 in core
    B_L1: int8[TK, TJ] = B[tk, tj]  # Load to L1 in core
    C_L1: int8[TI, TJ] = C[ti, tj]  # Load to L1 in core
...
def app_gemm():
    I, J, K = 2560, 4096, 65536
    TI, TJ, TK = 32, 64, 64  # Tile sizes
