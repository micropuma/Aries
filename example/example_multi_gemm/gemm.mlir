module {
  ...
  func.func @top(%A: memref<128x64xf32>, %B: memref<64x64xf32>, %C: memref<128x64xf32>, %D: memref<64x64xf32>, %E: memref<128x64xf32>)attributes {outArgs = [2 : i32, 4 : i32], top_host}{
