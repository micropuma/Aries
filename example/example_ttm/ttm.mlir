...
// module {
//   func.func @ttm(%A: memref<4x256x256xi32>, %B: memref<256x256xi32>, %C: memref<4x256x256xi32>) {
//     affine.for %i = 0 to 4 {
//       affine.for %j = 0 to 256 {
//         affine.for %k = 0 to 256 {
//           affine.for %l = 0 to 256 {
//             %0 = affine.load %A[%i, %j, %l] : memref<4x256x256xi32>
//             %1 = affine.load %B[%l, %k] : memref<256x256xi32>
//             %2 = arith.muli %0, %1 : i32
//             %3 = affine.load %C[%i, %j, %k] : memref<4x256x256xi32>
//             %4 = arith.addi %3, %2 : i32
//             affine.store %4, %C[%i, %j, %k] : memref<4x256x256xi32>
//           } {reduction}
//         }
//       }
//     }
