...
void kernel_gemm0(input_buffer<int32_t, adf::extents<1024>>& __restrict in0, input_buffer<int32_t, adf::extents<1024>>& __restrict in1, output_cascade<acc80>& __restrict out0) {
