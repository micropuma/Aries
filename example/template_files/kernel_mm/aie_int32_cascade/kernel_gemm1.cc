...
void kernel_gemm1(input_buffer<int32_t, adf::extents<1024>>& __restrict in0, input_buffer<int32_t, adf::extents<1024>>& __restrict in1, input_cascade<acc80>& __restrict accin, output_cascade<acc80>& __restrict out0) {
