...
void kernel_mttkrp0(input_buffer<float, extents<A_SIZE>>&  in0, input_buffer<float, extents<B_SIZE>>& in1, input_buffer<float, extents<C_SIZE>>& in2, output_buffer<float, extents<D_SIZE>>& out0){
