...
static LogicalResult printConstantOp(CppEmitter &emitter, Operation *operation,
  ...
  bool vector = false;
  if(emitter.vitis() && (llvm::isa<mlir::DenseIntElementsAttr>(value) || 
                         llvm::isa<mlir::DenseFPElementsAttr>(value) ))
    vector =true;
...
CppEmitter::CppEmitter(raw_ostream &os, bool declareVariablesAtTop, 
                       bool aie2, bool vitis, bool enres)
    : os(os), declareVariablesAtTop(declareVariablesAtTop), 
    aie2_(aie2), vitis_(vitis), enres_(enres) {
...
LogicalResult aries::emitAIEVecToCpp(Operation *op, bool aie2,
                                     bool vitis, bool enres, raw_ostream &os) {
  CppEmitter emitter(os, false, aie2, vitis, enres);
