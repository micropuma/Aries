...
void {{dst_name}}(input_buffer<float, adf::extents<A_SIZE>>& __restrict in0, input_buffer<float, adf::extents<B_SIZE>>& __restrict in1, input_buffer<float, adf::extents<C_SIZE>>& __restrict in2, output_buffer<float, adf::extents<C_SIZE>>& __restrict out0) {
