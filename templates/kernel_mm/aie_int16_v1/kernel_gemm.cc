...
void {{dst_name}}(input_buffer<int16_t, adf::extents<A_SIZE>>& __restrict in0, input_buffer<int16_t, adf::extents<B_SIZE>>& __restrict in1, input_buffer<int16_t, adf::extents<C_SIZE>>& __restrict in2, output_buffer<int16_t, adf::extents<C_SIZE>>& __restrict out0) {
