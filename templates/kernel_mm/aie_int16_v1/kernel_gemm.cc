...
void kernel_gemm(input_buffer<int16_t, adf::extents<A_SIZE>>& __restrict in0, input_buffer<int16_t, adf::extents<B_SIZE>>& __restrict in1, input_buffer<int16_t, adf::extents<C_SIZE>>& __restrict in2, output_buffer<int16_t, adf::extents<C_SIZE>>& __restrict out0) {
  int16_t * __restrict lhs = (int16_t *)in0.data();
  int16_t * __restrict rhs = (int16_t *)in1.data();
  int16_t * __restrict accin = (int16_t *)in2.data();
