...
void {{dst_name}}(input_buffer<int32_t, adf::extents<A_SIZE>>& __restrict in0, input_buffer<int32_t, adf::extents<B_SIZE>>& __restrict in1, output_buffer<int32_t, adf::extents<C_SIZE>>& __restrict out0) {
