        ...
        for (int v199 = 0; v199 < 32; v199++) {	// L404
          for (int v200 = 0; v200 < 1; v200++) {	// L405
            ...
            #pragma HLS pipeline II=1
              ...
              ap_int<512> v203;
              if (v202) {	// L408
                ap_int<512> v204 = v195.read(); //v195                v204 = v195;	// L409
                v203 = v204;	// L410
              } else {
                ap_int<512> v205 = v193.read(); //v193                v205 = v193;	// L412
                v203 = v205;	// L413
              }
        ...
        for (int v207 = 0; v207 < 32; v207++) {	// L421
          for (int v208 = 0; v208 < 1; v208++) {	// L422
            ...
            #pragma HLS pipeline II=1
              ...
              ap_int<512> v211;
              if (v210) {	// L425
                ap_int<512> v212 = v192.read(); //v192                v212 = v192;	// L426
                v211 = v212;	// L427
              } else {
          ...
          for (int v228 = 0; v228 < 32; v228++) {	// L451
            for (int v229 = 0; v229 < 1; v229++) {	// L452
              ...
              #pragma HLS pipeline II=1
                ...
                if (v232) {	// L456
                  v221.write(v231); //v221                  v221 = v231;	// L457
                } else {
                  v220.write(v231); //v220                  v220 = v231;	// L459
                }
              }
            }
          }
          ...
          for (int v234 = 0; v234 < 32; v234++) {	// L466
            for (int v235 = 0; v235 < 1; v235++) {	// L467
              ...
              #pragma HLS pipeline II=1
                ...
                if (v238) {	// L471
                  v223.write(v237); //v223                  v223 = v237;	// L472
                } else {
                  v222.write(v237); //v222                  v222 = v237;	// L474
                }
              }
            }
          }
            ...
            for (int v284 = 0; v284 < 1; v284++) {	// L531
              ...
              #pragma HLS pipeline II=1
                ...
                if (v287) {	// L535
                  ...
                  v275.write(v286); //v275                  v275 = v286;	// L538
                }
              }
            }
          }
            ...
            for (int v290 = 0; v290 < 1; v290++) {	// L546
              ...
              #pragma HLS pipeline II=1
                ...
                if (v293) {	// L550
                  ...
                  v276.write(v292); //v276                  v276 = v292;	// L553
                }
              }
            }
          }
...
void gemm_pl(
  ...
  send3_top(v308, v322, v313, v320, v303, v324, v311, v321);	// L593
  receive2_top(v312, v316, v307, v314, v309, v317, v306, v315);	// L594
  send6_top(v305, v319, v304, v325, v302, v318, v310, v323);	// L595
  store0_0_top(v314, v326, v315, v327, v316, v328, v317, v329);	// L596
  store0_top(v301, v328, v327, v329, v326);	// L597
  load0_top(v299, v332, v333, v330, v331);	// L598
  load0_3_top(v333, v325, v332, v323, v331, v319, v330, v318, v337, v324, v336, v322, v335, v321, v334, v320);	// L599
  load1_top(v300, v335, v334, v337, v336);	// L600
}
...
int main(int argc, char **argv) {
  ...
  // Define arguments
  auto in_bohdl0 = xrt::bo(device, 4096 * sizeof(float), top_0.group_id(0));
  auto in_bomapped0 = in_bohdl0.map<float*>();
  for (unsigned i=0; i < 4096; i++){
    in_bomapped0[i] = (float)(rand()%5);
  }
  in_bohdl0.sync(XCL_BO_SYNC_BO_TO_DEVICE, 4096 * sizeof(float), 0);
  ...
  in_bohdl1.sync(XCL_BO_SYNC_BO_TO_DEVICE, 4096 * sizeof(float), 0);

  auto out_bohdl0 = xrt::bo(device, 4096 * sizeof(float), top_0.group_id(0));
  ...
  out_bohdl0.sync(XCL_BO_SYNC_BO_FROM_DEVICE , 4096 * sizeof(float), 0);
...
[connectivity]
nk = top:1:top_0
stream_connect = ai_engine_0.v11:top_0.v348
stream_connect = ai_engine_0.v10:top_0.v351
stream_connect = top_0.v341:ai_engine_0.v9
stream_connect = top_0.v344:ai_engine_0.v8
stream_connect = ai_engine_0.v7:top_0.v345
stream_connect = top_0.v352:ai_engine_0.v6
stream_connect = top_0.v350:ai_engine_0.v5
stream_connect = ai_engine_0.v4:top_0.v346
stream_connect = top_0.v347:ai_engine_0.v3
stream_connect = top_0.v349:ai_engine_0.v2
stream_connect = top_0.v342:ai_engine_0.v1
stream_connect = top_0.v343:ai_engine_0.v0
