...
module {
  ...
  func.func @gemm_pl(%arg0: memref<64x4xi512>, %arg1: memref<64x4xi512>, %arg2: memref<64x4xi512>, %arg3: memref<1xi128, "plio">, %arg4: memref<1xi128, "plio">, %arg5: memref<1xi128, "plio">, %arg6: memref<1xi128, "plio">, %arg7: memref<1xi128, "plio">, %arg8: memref<1xi128, "plio">, %arg9: memref<1xi128, "plio">, %arg10: memref<1xi128, "plio">, %arg11: memref<1xi128, "plio">, %arg12: memref<1xi128, "plio">, %arg13: memref<1xi128, "plio">, %arg14: memref<1xi128, "plio">) attributes {adf.pl = true, dataflow, inline = false, mem_idx = [0 : i32, 1 : i32, 2 : i32], mem_type = [f32, f32, f32]} {
    ...
    call @send3_top(%arg3, %alloc_7, %arg12, %alloc_5, %arg7, %alloc_9, %arg14, %alloc_6) : (memref<1xi128, "plio">, memref<1xi128, "stream">, memref<1xi128, "plio">, memref<1xi128, "stream">, memref<1xi128, "plio">, memref<1xi128, "stream">, memref<1xi128, "plio">, memref<1xi128, "stream">) -> ()
    call @receive2_top(%arg11, %alloc_1, %arg8, %alloc, %arg10, %alloc_2, %arg9, %alloc_0) : (memref<1xi128, "plio">, memref<1xi128, "stream">, memref<1xi128, "plio">, memref<1xi128, "stream">, memref<1xi128, "plio">, memref<1xi128, "stream">, memref<1xi128, "plio">, memref<1xi128, "stream">) -> ()
    call @send6_top(%arg5, %alloc_4, %arg6, %alloc_10, %arg4, %alloc_3, %arg13, %alloc_8) : (memref<1xi128, "plio">, memref<1xi128, "stream">, memref<1xi128, "plio">, memref<1xi128, "stream">, memref<1xi128, "plio">, memref<1xi128, "stream">, memref<1xi128, "plio">, memref<1xi128, "stream">) -> ()
    ...
    call @store0_top(%arg2, %alloc_12, %alloc_11, %alloc_14, %alloc_13) : (memref<64x4xi512>, memref<1xi512, "stream2">, memref<1xi512, "stream2">, memref<1xi512, "stream2">, memref<1xi512, "stream2">) -> ()
    call @load0_top(%arg0, %alloc_18, %alloc_17, %alloc_16, %alloc_15) : (memref<64x4xi512>, memref<1xi512, "stream2">, memref<1xi512, "stream2">, memref<1xi512, "stream2">, memref<1xi512, "stream2">) -> ()
    ...
    call @load1_top(%arg1, %alloc_19, %alloc_20, %alloc_22, %alloc_21) : (memref<64x4xi512>, memref<1xi512, "stream2">, memref<1xi512, "stream2">, memref<1xi512, "stream2">, memref<1xi512, "stream2">) -> ()
    return
  }
  func.func @gemm(%arg0: memref<64x4xi512>, %arg1: memref<64x4xi512>, %arg2: memref<64x4xi512>, %arg3: memref<1xi128, "plio">, %arg4: memref<1xi128, "plio">, %arg5: memref<1xi128, "plio">, %arg6: memref<1xi128, "plio">, %arg7: memref<1xi128, "plio">, %arg8: memref<1xi128, "plio">, %arg9: memref<1xi128, "plio">, %arg10: memref<1xi128, "plio">, %arg11: memref<1xi128, "plio">, %arg12: memref<1xi128, "plio">, %arg13: memref<1xi128, "plio">, %arg14: memref<1xi128, "plio">) attributes {adf.func, plio = true} {
    ...
    adf.connect(%1, %arg11) {top_config} : (!adf.plio<Out, 128>, memref<1xi128, "plio">)
    ...
    adf.connect(%arg5, %3) {top_config} : (memref<1xi128, "plio">, !adf.plio<In, 128>)
    %4 = adf.graph.io(PLIO) : !adf.plio<Out, 128>
    adf.connect(%4, %arg9) {top_config} : (!adf.plio<Out, 128>, memref<1xi128, "plio">)
    ...
    adf.connect(%arg14, %6) {top_config} : (memref<1xi128, "plio">, !adf.plio<In, 128>)
    ...
    adf.connect(%arg3, %8) {top_config} : (memref<1xi128, "plio">, !adf.plio<In, 128>)
    ...
    adf.connect(%arg7, %10) {top_config} : (memref<1xi128, "plio">, !adf.plio<In, 128>)
    %11 = adf.graph.io(PLIO) : !adf.plio<In, 128>
    adf.connect(%arg6, %11) {top_config} : (memref<1xi128, "plio">, !adf.plio<In, 128>)
